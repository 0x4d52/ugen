// $Id: ugen_Buffer.h 1003 2010-03-12 16:29:12Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/buffers/ugen_Buffer.h $
...
//	inline const float* getDataReadOnly(const int channel = 0) const throw()			{ ugen_assert(channel >= 0); return channels[channel % numChannels_]->data; }
...
//	inline const float* getDataUncheckedReadOnly(const int channel = 0) const throw()	{ ugen_assert(channel >= 0); return channels[channel]->data; }
