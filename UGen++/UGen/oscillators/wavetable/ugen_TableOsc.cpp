// $Id: ugen_TableOsc.cpp 980 2010-01-15 21:59:10Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/oscillators/wavetable/ugen_TableOsc.cpp $
...
{	
	...
	for(int i = 0; i < numInternalUGens; i++)
	{
		internalUGens[i] = new TableOscUGenInternal(freq, initialPhase.wrapAt(i), Buffer::tableSine8192);
	}
}
