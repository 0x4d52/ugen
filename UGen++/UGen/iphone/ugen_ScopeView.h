...
//- (float)getYMaximum;
//- (void)setScaleX:(ScopeGUI::Scales)scale:(double)markSpacing:(int)labelHop:(BOOL)labelFirst;
//- (ScopeGUI::Scales)getScaleX;
//- (void)setScaleY:(ScopeGUI::Scales)scale:(double)markSpacing:(int)labelHop:(int)decimalPlaces;
