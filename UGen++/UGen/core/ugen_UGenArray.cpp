// $Id: ugen_UGenArray.cpp 993 2010-03-03 21:47:50Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/core/ugen_UGenArray.cpp $
...
UGen& UGenArray::wrapAt(const int index) throw()
{
	...
	if(internal == 0) return UGen::null;
