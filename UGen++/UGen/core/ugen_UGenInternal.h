// $Id: ugen_UGenInternal.h 993 2010-03-03 21:47:50Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/core/ugen_UGenInternal.h $
...
public:
	...
	UGen& getInput(const int index) throw();	
