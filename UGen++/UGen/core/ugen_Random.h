// $Id: ugen_Random.h 1006 2010-03-18 12:26:09Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/core/ugen_Random.h $
...
public:
	...
	inline double operator() (double scale)  throw() { return nextLinearDouble(scale); }
	inline double operator() (double lo, double hi) throw() { return nextLinearDouble(hi-lo)+lo; }
