// $Id: ugen_UGen.cpp 993 2010-03-03 21:47:50Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/core/ugen_UGen.cpp $
...
UGen& UGen::getInput(const int input, const int channel) throw()
{
...
void UGen::steal(const bool forcedSteal) throw()
{
	if(forcedSteal == true)
	{
		...
		{
			internalUGens[i]->decrementRefCount();
			internalUGens[i] = (UGen::null).getInternalUGen(0);
		}
	}
	else
	{
