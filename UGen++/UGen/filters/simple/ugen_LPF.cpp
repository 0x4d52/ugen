// $Id: ugen_LPF.cpp 1006 2010-03-18 12:26:09Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/filters/simple/ugen_LPF.cpp $
...
//	ugen_assert(newFreq < (UGen::getSampleRate() * 0.5));
	...
	if(newFreq != currentFreq)
	{
		...
		float a0_slope = (next_a0 - a0) * oneOverFilterLoops;
		float b1_slope = (next_b1 - b1) * oneOverFilterLoops;
		float b2_slope = (next_b2 - b2) * oneOverFilterLoops;
