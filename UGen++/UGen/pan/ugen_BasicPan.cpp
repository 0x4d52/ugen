// $Id: ugen_BasicPan.cpp 980 2010-01-15 21:59:10Z mgrobins $
// $HeadURL: http://dsrowlan@164.11.131.73/svn/CEMS/mt/other/UGenProject/UGen/pan/ugen_BasicPan.cpp $
...
:	ProxyOwnerUGenInternal(NumInputs, 1),
	panTable(Buffer::tableConstantPan512),
	lastPos(position.getValue(0)),
...
{		
	...
	float posValue = positionChecked.getValue(0);
