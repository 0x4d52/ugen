...
*/
#define JucePlugin_Name                     "UGen++ Demo Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A Demo Plugin using Juce/UGen++ for a plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'UGp0'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           UGenAU ## UGenPlug

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "UGenAU" "UGenPlug"
