...
//// UGenAUPatch - these two lines ////
#include <juce/extras/audio plugins/wrapper/juce_PluginHeaders.h>
#include <juce/extras/audio plugins/wrapper/juce_PluginHostType.h>
...
//// UGenAUPatch - this line ////
extern UGenPlugin* JUCE_CALLTYPE createPluginFilter();
...
public:
                                      ...
                                      AudioUnitParameterInfo& outParameterInfo)
    {
             ...
             && index < juceFilter->getNumParameters())
        {
			...
			if(units.equalsIgnoreCase("hz") || units.equalsIgnoreCase("cps"))
			{
				outParameterInfo.unit = kAudioUnitParameterUnit_Hertz;
			}
			else if(units.equalsIgnoreCase("x"))
			{
...
private:
	...
	ScopedPointer<UGenPlugin> juceFilter; //// UGenAUPatch - change to this ////
